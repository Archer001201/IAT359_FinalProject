...
public class Constants {
    ...
    //Constants of character_dialogue
    public static final String CHARACTER_DIALOGUE_TABLE = "character_dialogue";
    public static final String NAME_DIALOGUE = "name_dialogue";
